...
module InclusiveCacheControl(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:38:9]
  ...
  input  [6:0]  auto_ctrl_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  output [6:0]  auto_ctrl_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  wire [6:0]       _out_back_front_q_io_deq_bits_extra_tlrr_extra_source;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
