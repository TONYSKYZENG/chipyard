...
module Queue2_AXI4BundleAW(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [37:0] io_enq_bits_addr,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [37:0] io_deq_bits_addr,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[41:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_len = _ram_ext_R0_data[49:42];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_size = _ram_ext_R0_data[52:50];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_burst = _ram_ext_R0_data[54:53];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_lock = _ram_ext_R0_data[55];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cache = _ram_ext_R0_data[59:56];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_prot = _ram_ext_R0_data[62:60];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_qos = _ram_ext_R0_data[66:63];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
