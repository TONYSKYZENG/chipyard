...
module SinkC(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
  ...
  output [1:0]  io_req_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output [1:0]  io_resp_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  input  [1:0]  io_c_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  wire [1:0]  _c_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue2_TLBundleC_a32d64s2k3z3c c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
