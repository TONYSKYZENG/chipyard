...
module TLFragmenter_Debug(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  TLMonitor_20 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_source  (auto_anon_out_d_bits_source[6:4])	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:238:47]
  );	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
  Repeater_TLBundleA_a12d64s3k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
